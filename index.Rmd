...
```{r, echo=FALSE}
ggplotly(plot_both_acousticenergy)
```

These figures indeed show mostly high acoustiness and low energy in Coffeehouse, and high energy and low acousticness in On the Road. Valence shows that songs with high energy and low acoustiness are happiest. 
