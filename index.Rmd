...
So, high *energy* is characteristic for Road Trip songs, whereas high *acousticness* is characteristic for Coffeehouse songs. I decided to plot energy and acousticness for both playlists, to see a clear difference.

## Outliers
--------------------------------------------------------------------------------------------

Shotgun (George Ezra), Girl on Fire (Alicia Keys) and Say Something (Justin Timberlake) are in one of the Coffeehouse playlists, although I feel like they could have also been Roadtrip songs. They are all quite popular songs with high energy and low acousticness:



Say Something = popularity: 62, energy: 0.632, acousticness: 0.103
Fire = 73, 0.706, 0.135
Shotgun = 86, 0.735, 0.286

![Figure 1: scatterplot for energy and acousticness](RplotBOTH.png)
